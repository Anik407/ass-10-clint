...
const Blog = () => {
    ...
    return (
        <div ref={ref}>
            ...
            <ReactToPrint trigger={()=><button className="bg-transparent ms-4  hover:bg-lime-400 text-lime-400 hover:text-slate-100 py-2 px-4 border border-lime-400 hover:border-transparent rounded">Convert To PDF</button>} content={()=>ref.current}/>
        </div>
    );
};
